...
export const registerUserSchema = z.object({
	username: z.string().regex(usernameRegex, {
		message:
			" Username can only contains letters(uppercase and lowercase), digits,_, @, +, ., and -",
	}),
	first_name: z
		.string()
		.trim()
    ...
    re_password: z.string().min(8,{message:"ConfirmPassword must be at least 8 characters long"}),
