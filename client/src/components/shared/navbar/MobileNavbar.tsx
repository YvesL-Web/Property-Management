						...
						<SheetFooter>
							{isAuthenticated ? (
								...
								<div className="mt-4">
									...
									<Link href="/login">
										<Button className="lime-gradient small-medium light-border-2 btn-tertiary text-babyPowder mt-3 min-h-[41px] w-full rounded-lg border px-4 py-3 shadow-none">
											Login
										</Button>
									</Link>
								</div>
