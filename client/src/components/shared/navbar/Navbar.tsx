...
const Navbar = () => {
  return (
		<nav className="flex-between bg-baby_rich border-b-platinum shadow-platinum fixed z-50 w-full gap-5 border-b p-4 sm:p-6 lg:px-12 dark:border-b-0 dark:shadow-none">
